...
const translations = {
  en: {
    ...
    subtitle:
      'A fair cleaning rota for the flat. The next person is chosen based on completed work, recent responsibilities, and upcoming workload.',
    navigation: 'Navigation',
    dashboard: 'Overview',
    nextTasks: 'Upcoming chores',
    nextTasksHelp: 'See what is due, overdue, or needs doing when full.',
    ...
    scores: 'Points',
    scoresHelp:
      'Difficulty points show how hard a chore is. Earned points show work completed in the current period.',
    ...
    didVacuumHelp:
      'Mopping usually needs vacuuming first. If vacuuming was not done, the mopping points are reduced.',
    ...
    historyHelp:
      'When flatmates change, the current period is closed. Its activity, points, and milestones stay here, while the new period starts from zero.',
    periodLogs: 'Activity',
    periodScores: 'Points',
  ...
  de: {
    ...
    title: 'Putzplan',
    subtitle:
      'Ein fairer Putzplan für die WG. Die nächste Person wird anhand erledigter Arbeit, letzter Zuständigkeiten und kommender Belastung gewählt.',
    navigation: 'Navigation',
    dashboard: 'Übersicht',
    nextTasks: 'Anstehende Aufgaben',
    nextTasksHelp: 'Sieh, was fällig, überfällig oder bei Bedarf zu erledigen ist.',
    ...
    scores: 'Punkte',
    scoresHelp:
      'Schwierigkeitspunkte zeigen, wie aufwendig eine Aufgabe ist. Erarbeitete Punkte zeigen erledigte Arbeit in der aktuellen Periode.',
    ...
    didVacuumHelp:
      'Vor dem Nasswischen sollte normalerweise staubgesaugt werden. Ohne Staubsaugen gibt es weniger Punkte fürs Nasswischen.',
    ...
    adminHelp:
      'Aktive Mitbewohner verwalten. Wenn Mitbewohner hinzugefügt oder entfernt werden, startet eine neue faire Punkteperiode.',
    userName: 'Name',
    ...
    historyHelp:
      'Wenn Mitbewohner wechseln, wird die aktuelle Periode geschlossen. Aktivitäten, Punkte und Meilensteine bleiben hier erhalten, während die neue Periode bei null startet.',
