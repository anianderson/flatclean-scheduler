  ...
  const html = `
    <div style="font-family:Arial,sans-serif;line-height:1.5;color:#111827;max-width:680px">
      <section style="padding:16px 0">
        <h2 style="margin:0 0 8px">${escapeHtml(titleDe)}</h2>
        <p style="font-size:16px;margin:0 0 14px"><strong>${escapeHtml(summaryDe)}</strong></p>
        <div style="padding:12px 14px;border-radius:12px;background:#f8fafc;border:1px solid #e5e7eb">
          ${htmlParagraph(detailsDe)}
        </div>
      </section>
      ...
      <section style="padding:4px 0 16px">
        <h2 style="margin:0 0 8px">${escapeHtml(titleEn)}</h2>
        <p style="font-size:16px;margin:0 0 14px"><strong>${escapeHtml(summaryEn)}</strong></p>
        <div style="padding:12px 14px;border-radius:12px;background:#f8fafc;border:1px solid #e5e7eb">
          ${htmlParagraph(detailsEn)}
        </div>
      </section>
    </div>
  `;
